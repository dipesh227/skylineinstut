...
export default function StudentDashboardPage() {
  ...
  // Fetch student and settings from Supabase
  useEffect(() => {
  ...
  // Generate QR code when certificate tab is active and results exist
  useEffect(() => {
  ...
  // Show branded loading while data loads
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="flex items-center gap-4">
            {student.photo_base64 || student.photo_url ? (
              ...
              <div className="w-16 h-16 rounded-full bg-primary-light flex items-center justify-center border-2 border-secondary">
            ...
            <div className="space-y-1">
              ...
              <span className="inline-block px-2 py-0.5 bg-primary-light text-[10px] font-mono font-bold text-gray-300 rounded border border-primary-light">
      ...
      <div className="max-w-6xl w-full mx-auto px-4 md:px-6 py-8 flex-1 grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-gray-150 p-6 md:p-8 flex flex-col items-center justify-center text-center shadow-xs min-h-[400px]">
            ...
            {/* ID Card Tab – with SmartImage for all dynamic images */}
            {activeTab === 'idcard' && (
