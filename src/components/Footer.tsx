      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">India&apos;s leading training institute for Bartending, Advanced Flair, Barista Coffee Craftsmanship, and 5-Star F&amp;B Operations.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3">
              <h5 className="text-[11px] font-bold text-secondary uppercase tracking-wider mb-2">Social Networks</h5>
              <div className="flex gap-2.5">
                {settings.social_facebook && <a href={settings.social_facebook} target="_blank" className="p-2 rounded-lg bg-white/5 hover:bg-secondary hover:text-accent text-gray-300 transition-all text-xs">FB</a>}
                {settings.social_instagram && <a href={settings.social_instagram} target="_blank" className="p-2 rounded-lg bg-white/5 hover:bg-secondary hover:text-accent text-gray-300 transition-all text-xs">IG</a>}
                {settings.social_linkedin && <a href={settings.social_linkedin} target="_blank" className="p-2 rounded-lg bg-white/5 hover:bg-secondary hover:text-accent text-gray-300 transition-all text-xs">IN</a>}
                {settings.social_youtube && <a href={settings.social_youtube} target="_blank" className="p-2 rounded-lg bg-white/5 hover:bg-secondary hover:text-accent text-gray-300 transition-all text-xs">YT</a>}
              </div>
            </div>
          </div>
        </div>
